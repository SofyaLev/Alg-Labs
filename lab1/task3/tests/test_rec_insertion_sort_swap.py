...
from lab1.task3.src.rec_insertion_sort_swap import rec_insertion_sort_swap, main


class TestRecInsertionSortSwap(unittest.TestCase):
    ...
    def test_should_sort_sorted_array(self):
        ...
        # when
        result = rec_insertion_sort_swap(n, array)
